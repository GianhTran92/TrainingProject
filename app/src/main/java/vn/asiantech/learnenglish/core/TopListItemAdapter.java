...
public class TopListItemAdapter extends BaseAdapter {
	 ...
	 * @param arr
	 */
	public TopListItemAdapter(Context mContext, ArrayList<TopModel> arr){
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.listview_top_list_item, parent, false);
